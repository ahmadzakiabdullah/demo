...
export default function Index({ event, teams, sports, statuses, filters }) {
    ...
    useEffect(() => {
        const timeout = setTimeout(() => {
            router.get(
                route('admin.events.teams.index', event.id),
                                ...
                                {teams.data.length === 0 ? (
                                    ...
                                    teams.data.map((team) => (
                                        <TableRow key={team.id}>
                                            ...
                                            <TableCell>{team.athletes_count}</TableCell>
                                            <TableCell>
                                                <Badge>
