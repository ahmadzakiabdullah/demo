...
export default function Show({
    ...
    const certExpired =
        ...
        new Date(official.certification_expires_at) < new Date();
    ...
    return (
        ...
        >
            <Head title={`${official.name} — ${event.name}`} />
                    ...
                    <Card className="lg:col-span-2">
                        ...
                        <CardContent className="grid gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <p className="font-medium">
                                    {official.certification_level || 'Not set'}
                                </p>
                            </div>
                            <div>
                                <p className="text-sm text-muted-foreground">
                                ...
                                <Badge
                                    variant={certExpired ? 'secondary' : 'default'}
                                >
                                    {official.certification_expires_at
                                        ? certExpired
                                            ? 'Expired'
