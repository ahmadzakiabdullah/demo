...
class OfficialsPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = collect(['officials'])->flatMap(function (string $module) {
        ...
        $this->attachToRole(Role::ORG_ADMIN, [
            Permissions::slug('officials', 'view'),
            Permissions::slug('officials', 'create'),
            Permissions::slug('officials', 'update'),
            Permissions::slug('officials', 'delete'),
            Permissions::slug('officials', 'manage'),
        ], $permissions);
        ...
        $this->attachToRole(Role::OFFICIAL, [
            Permissions::slug('officials', 'view'),
            Permissions::slug('officials', 'create'),
            Permissions::slug('officials', 'update'),
        ], $permissions);
